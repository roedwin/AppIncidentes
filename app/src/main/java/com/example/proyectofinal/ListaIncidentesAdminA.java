...
public class ListaIncidentesAdminA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPdf = findViewById(R.id.generarPDFA);
    ...
    public void exportarPDF(){
        ...
        try {
            ...
            table1.addCell(new Cell(1,3).add(new Paragraph("Reporte de Incidentes Activos")
                            .setFontSize(20f))
            ...
            float anchoColumna[]= {140f,140f,120f,140f};
            ...
            celdaMarca.add(new Paragraph("Fecha de Recibido"));
            ...
            reference.orderByChild("estado").equalTo("Activo").addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    documento.add(tabla);
                    documento.close();
                    abrirPDF(file,ListaIncidentesAdminA.this);
                }

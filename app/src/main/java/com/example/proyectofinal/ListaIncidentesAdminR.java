...
public class ListaIncidentesAdminR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPdf = findViewById(R.id.generarPDFR);
    ...
    public void verificarPermisos(){
        ...
        int estadoPermiso = ContextCompat.checkSelfPermission(ListaIncidentesAdminR.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        if(estadoPermiso == PackageManager.PERMISSION_GRANTED){
            permisos_concedido();
        }else{
            ActivityCompat.requestPermissions(ListaIncidentesAdminR.this,new String[]{
    ...
    public void permisos_concedido(){
        ...
        {
            if(carpeta.mkdir()){
                Toast.makeText(ListaIncidentesAdminR.this, "El directorio fue creado", Toast.LENGTH_SHORT).show();
            }
        }
        permisos= true;
    }
    ...
    public void exportarPDF(){
        ...
        try {
            ...
            table1.addCell(new Cell(1,3).add(new Paragraph("Reporte de Incidentes Resueltos")
                            .setFontSize(20f))
            ...
            float anchoColumna[]= {140f,120f,140f,120f};
            ...
            celdaMarca.add(new Paragraph("Solucion"));
            ...
            reference.orderByChild("estado").equalTo("Resuelto").addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    for (DataSnapshot myData : snapshot.getChildren()){
                        ...
                        Marca.add(new Paragraph(myData.child("mensaje").getValue().toString()));
                        tabla.addCell(Marca);
                    }
                    ...
                    documento.add(tabla);
                    documento.close();
                    abrirPDF(file,ListaIncidentesAdminR.this);
                }
